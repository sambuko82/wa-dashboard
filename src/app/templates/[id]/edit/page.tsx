      ...
      <div className="app-page-header">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <h1 className="app-page-title mt-4">Edit Template</h1>
            <p className="app-page-description">{name}</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="app-card space-y-4 p-5">
          <div>
            ...
            <input required value={name} onChange={(e) => setName(e.target.value)} className="app-input" />
          </div>
          <div>
            <label className="mb-2 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">
              Description <span className="font-normal text-slate-400">(optional)</span>
            </label>
            <input value={description} onChange={(e) => setDescription(e.target.value)} className="app-input" />
          </div>
